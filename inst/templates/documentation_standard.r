...
## *file* documentation_standard.R 
## 
## provide a template for create_documentation() using standard R comments only.
## Since we don't distinguish between markdown and standard R comments,
## the markdown documentation will get cluttered with standard R comments
## converted to normal text.
## 
## *author* Dominik Cullmann <dominik.cullmann@@forst.bwl.de>  
## *section Version:* $Id: b11ee2637e395382ac0c83db982154400e1d174e $  
...
#######  
####### Note that we use 7 hashes to set the function documentation as normal 
####### text.       
####### Also note that we need to end this chunk of normal text with a blank
####### comment line.
#######  
