...
##%
## Ah: and both headers should should follow each other directly, the roxygen
## header terminated by a NULL statement, the markdown header by a blank line.
## You could possibly have the NULL statement after the blank line or the other
## way round and you can mix the lines of the two different headers, but this is
## not likely to encrease maintainability.
